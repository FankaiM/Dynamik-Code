...
for i=1:length(rob.kl)
    ...
    M_str_i=[rob.kl(i).m*eye(3,3)        ,       rob.kl(i).m*tilde(rob.kl(i).Bi_r_s)';
             rob.kl(i).m*tilde(rob.kl(i).Bi_r_s) ,  rob.kl(i).I_o  ];
  
    dM=[rob.kl(i).Bi_Jt_o;rob.kl(i).Bi_Jr]'*M_str_i*[rob.kl(i).Bi_Jt_o;rob.kl(i).Bi_Jr];
